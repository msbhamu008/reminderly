...
export default function EmailTemplatesPage() {
  ...
  useEffect(() => {
    setPreviewSubject(replaceTemplateVariables(template.subject, previewData))
    setPreviewBody(replaceTemplateVariables(template.body, previewData))
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="border rounded-md">
                        <textarea
                          ...
                          className="min-h-[300px] w-full rounded-md border-0 bg-transparent p-3 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none"
                          placeholder="Email body content"
                        />
                      </div>
                      <p className="text-xs text-muted-foreground">
                        Use HTML tags for formatting. Use {"{variable}"} syntax for dynamic content.
                      </p>
                    </div>
